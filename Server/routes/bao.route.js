...
router.get('/getAllApprovedDealerSale', baoController.getAllApprovedDealerSale);
router.get('/getReturnedByCDAODealerSale', baoController.getReturnedByCDAODealerSale);
router.get('/getReturnedToDealerSale', baoController.getReturnedToDealerSale);
router.post('/returnToDealer', baoController.returnToDealer);
router.post('/ReconfirmDealerSale', baoController.ReconfirmDealerSale);
router.post('/returnedSaleCDAOToDealer', baoController.returnedSaleCDAOToDealer);
router.get('/getAllDemonstrationData', baoController.getAllDemonstrationData);
